...
class ConnectyCubeLoginScreen extends StatelessWidget {
  static const String TAG = "ConnectyCubeLoginScreen";
...
class BodyState extends State<BodyLayout> {
  static const String TAG = "ConnectyCubeConnectyCubeLoginScreen.BodyState";
