                  ...
                  children: [
                    ...
                    Center(
                      child: Column(
                        children: [
                          ...
                          TestCards(titleText: "Ray Optics", date: "04/08/22", time: "9:30", maxMarks: 75, profName: "Mr. John Doe"),
                          const SizedBox(height: 20),
                          GestureDetector(
                            onTap: () {
                    ...
                    Row(
                      children: const [
                        ...
                        SizedBox(width: 10),
                        Text("The paper contains 10 questions.",
                        style: TextStyle(
                    ...
                    Row(
                      children: const [
                        Icon(Icons.check_circle, color: Color(0xff27D381)),
                        SizedBox(width: 10),
                        Text("The paper will  close after 30 minutes.",
                          style: TextStyle(
                            color: Color(0xffABABAB),
                            fontSize: 14,
                          ),)
                    ...
                    Row(
                      children: const [
                        Icon(Icons.check_circle, color: Color(0xff27D381)),
                        SizedBox(width: 10),
                        Text("Have a stable network connection.",
                          style: TextStyle(
                            color: Color(0xffABABAB),
                            fontSize: 14,
                          ),)
                    ...
                    Row(
                      children: const [
                        Icon(Icons.check_circle, color: Color(0xff27D381)),
                        SizedBox(width: 10),
                        Text("Take the test in a closed room.",
                          style: TextStyle(
                            color: Color(0xffABABAB),
                            fontSize: 14,
                          ),
